...
*/
public class QuadradoRedimensionavel public class QuadradoRedimensionavel extends Quadrado implements Redimensionavel {

    public QuadradoRedimensionavel(double ladoInf) {
        super(ladoInf);
    }
